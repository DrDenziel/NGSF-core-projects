library(Rsubread)
library(magrittr)
setwd("/datastore/NGSF001/projects/22-1LICH-001/daniel_analysis/")
result_dir="daniel_alignment"
...
feature_count <- sapply(sample_names, function(x)
			   ...
			   annot.ext="/datastore/NGSF001/analysis/references/human/gencode-30/gencode.v30.annotation.gtf",
